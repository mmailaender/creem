...
The diagram below shows how subscription access is managed based on different states:

![Subscription Access States](/images/subscription-states.jpeg)

<Tip>
Use the `onGrantAccess` and `onRevokeAccess` callbacks to automatically handle access management. See [Managing Subscription Access](#managing-subscription-access) below.
</Tip>
