...
- Third-party content downloaders and rippers — tools that download, rip, extract, or save content from platforms whose Terms of Service prohibit such actions. This includes video downloaders, audio rippers, stream recorders, and "save from" tools targeting platforms such as YouTube, TikTok, Spotify, Twitch, Instagram, Facebook, SoundCloud, X (Twitter), Pinterest, Vimeo, Netflix, and similar streaming or social media services. Tools that only process user-owned content or integrate via official APIs with proper authorization are not affected.
